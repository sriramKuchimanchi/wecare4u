...
const initialSession: EmergencySession = {
  ...
  steps: [
    ...
    { step: 'provider_found', title: 'Nearest Care Provider Found', description: 'Sunrise Home Care & Response (2.4 km away)', status: 'completed', completedAt: new Date().toISOString() },
    { step: 'professional_assigned', title: 'Nearest Professional Assigned', description: 'Layla Al-Nasser (Senior Emergency Caregiver)', status: 'completed', completedAt: new Date().toISOString() },
