...
export const mockCareRequests: CareRequest[] = [
  {
    ...
    internalNotes: ['Family requested female nurse.'],
    address: { line1: 'Gokuldham Heights, Flat 402', city: 'Mumbai', state: 'Maharashtra', postalCode: '400063', country: 'India' },
    estimatedCost: 1500,
    currency: '₹',
    ...
    timeline: [
      { status: 'requested', title: 'Request Submitted', description: 'Family requested urgent home nursing visit.', timestamp: hoursAgo(2) },
      { status: 'accepted', title: 'Request Accepted', description: 'Aastha Senior Care accepted the request.', timestamp: hoursAgo(1.5) },
      { status: 'on_the_way', title: 'Professional On The Way', description: 'Care professional is en route with medical kit.', timestamp: hoursAgo(0.3) },
    ],
  ...
  },
  {
    ...
    timeline: [
      { status: 'requested', title: 'Booking Confirmed', description: 'Scheduled physiotherapy booked.', timestamp: daysAgo(1) },
      { status: 'accepted', title: 'Accepted', description: 'Provider confirmed slot.', timestamp: daysAgo(1) },
      { status: 'arrived', title: 'Arrived at Location', description: 'Care professional reached patient home.', timestamp: hoursAgo(1) },
  ...
  },
  {
    ...
    timeline: [
      { status: 'requested', title: 'Emergency Request Submitted', description: 'Waiting for provider acceptance.', timestamp: hoursAgo(0.2) },
    ],
  ...
  },
  {
    ...
    internalNotes: ['Confirmed schedule for tomorrow 10:00 AM.'],
    address: { line1: 'Gokuldham Heights, Flat 402', city: 'Mumbai', state: 'Maharashtra', postalCode: '400063', country: 'India' },
    estimatedCost: 2500,
    currency: '₹',
    ...
    estimatedDuration: '45 mins',
    timeline: [
      { status: 'requested', title: 'Request Submitted', description: 'Doctor visit requested for tomorrow.', timestamp: hoursAgo(5) },
      { status: 'accepted', title: 'Request Accepted', description: 'Provider confirmed slot.', timestamp: hoursAgo(4) },
    ],
  ...
  },
  {
    ...
    timeline: [
      { status: 'requested', title: 'Request Created', description: 'Nurse visit requested.', timestamp: daysAgo(3) },
      { status: 'accepted', title: 'Accepted', description: 'Provider confirmed.', timestamp: daysAgo(2.5) },
      { status: 'on_the_way', title: 'On The Way', description: 'Care professional en route.', timestamp: daysAgo(2.3) },
      { status: 'arrived', title: 'Arrived', description: 'Care professional arrived on site.', timestamp: daysAgo(2.1) },
...
export const mockProviderServices: ProviderServiceItem[] = [
  { id: 'srv_1', name: 'In-Home Nursing Care', category: 'Home Nursing', description: 'Certified RN visits for wound care, injections, IV therapy & vital monitoring.', icon: 'HeartPulse', enabled: true, pricing: { amount: 1500, unit: 'per visit', currency: '₹' }, responseTime: '15-30 mins', coverageArea: 'Mumbai Metropolitan & Suburbs', contactNumber: '+91 98200 11223' },
  { id: 'srv_2', name: 'Elderly Caregiver Support', category: 'Caregiver', description: 'Compassionate assistance with daily living, hygiene, mobility & companionship.', icon: 'Users', enabled: true, pricing: { amount: 1000, unit: 'per 4 hrs', currency: '₹' }, responseTime: '30-45 mins', coverageArea: 'All Mumbai Zones', contactNumber: '+91 98200 11224' },
  { id: 'srv_3', name: 'Home Doctor Consultation', category: 'Doctor', description: 'Board-certified physicians for comprehensive health checkups & prescriptions at home.', icon: 'Stethoscope', enabled: true, pricing: { amount: 2500, unit: 'per visit', currency: '₹' }, responseTime: '20-40 mins', coverageArea: 'Mumbai & Thane', contactNumber: '+91 98200 11225' },
  { id: 'srv_4', name: 'Physiotherapy & Rehab', category: 'Physiotherapy', description: 'Customized physical rehabilitation for arthritis, post-stroke & joint mobility.', icon: 'Activity', enabled: true, pricing: { amount: 1800, unit: 'per session', currency: '₹' }, responseTime: '45-60 mins', coverageArea: 'Greater Mumbai', contactNumber: '+91 98200 11226' },
  { id: 'srv_5', name: 'Emergency Ambulance Transport', category: 'Ambulance', description: 'Rapid emergency dispatch with ICU-equipped ambulance & paramedic team.', icon: 'Ambulance', enabled: true, pricing: { amount: 3000, unit: 'per callout', currency: '₹' }, responseTime: '5-10 mins', coverageArea: '24/7 Citywide Coverage', contactNumber: '+91 98200 11227' },
  { id: 'srv_6', name: 'Diagnostic Lab Sample Pickup', category: 'Diagnostic Lab', description: 'Hygienic blood & sample collection at home with fast online lab results.', icon: 'FlaskConical', enabled: true, pricing: { amount: 600, unit: 'per pickup', currency: '₹' }, responseTime: '60 mins', coverageArea: 'All Districts', contactNumber: '+91 98200 11228' },
  { id: 'srv_7', name: 'Prescription Medicine Delivery', category: 'Pharmacy', description: 'Same-day home delivery of prescribed medications and OTC health supplies.', icon: 'Pill', enabled: true, pricing: { amount: 200, unit: 'per delivery', currency: '₹' }, responseTime: '30-60 mins', coverageArea: 'All Pin Codes', contactNumber: '+91 98200 11229' },
  { id: 'srv_8', name: 'Senior Wheelchair Transport', category: 'Transportation', description: 'Wheelchair-accessible vehicle transport for hospital visits & appointments.', icon: 'Car', enabled: true, pricing: { amount: 1200, unit: 'per trip', currency: '₹' }, responseTime: '20-30 mins', coverageArea: 'City Limits', contactNumber: '+91 98200 11230' },
  { id: 'srv_9', name: 'Senior Home Safety & Maintenance', category: 'Home Maintenance', description: 'Safety inspection, minor repairs, bathroom grab bar installation & light fixes.', icon: 'Wrench', enabled: true, pricing: { amount: 800, unit: 'per visit', currency: '₹' }, responseTime: '45 mins', coverageArea: 'Residential Complexes', contactNumber: '+91 98200 11231' },
  { id: 'srv_10', name: 'Senior Housekeeping & Sanitization', category: 'Housekeeping', description: 'Dust-free cleaning, linen changing & allergen sanitization for senior rooms.', icon: 'Home', enabled: false, pricing: { amount: 1000, unit: 'per session', currency: '₹' }, responseTime: '2 hours', coverageArea: 'Selected Pincodes', contactNumber: '+91 98200 11232' },
];
