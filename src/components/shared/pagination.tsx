...
export const Pagination = ({ page, totalPages, pageSize, total, onPageChange, className }: PaginationProps) => {
  const canPrev = page > 1;
  const canNext = page < totalPages;

  return (
    <div className={cn('flex flex-col items-center gap-3 py-4 md:flex-row md:justify-between', className)}>
